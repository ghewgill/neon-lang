...
extern const Number sdl$SDL_WINDOWEVENT = number_from_uint32(SDL_WINDOWEVENT);
extern const Number sdl$SDL_WINDOWEVENT_SHOWN = number_from_uint32(SDL_WINDOWEVENT_SHOWN);
