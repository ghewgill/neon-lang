if (NOT EXISTS external/IntelRDFPMathLib20U2)
    execute_process(
        COMMAND python3 ${CMAKE_SOURCE_DIR}/scripts/extract.py ${CMAKE_CURRENT_SOURCE_DIR}/IntelRDFPMathLib20U2.tar.gz .
...
target_include_directories(bid
    INTERFACE ${CMAKE_CURRENT_BINARY_DIR}/IntelRDFPMathLib20U2/LIBRARY/src
)
