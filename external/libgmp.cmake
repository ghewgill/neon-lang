...
if (WIN32)
    ...
    set_target_properties(gmp PROPERTIES IMPORTED_LOCATION external/lib/libgmp.a)
    set_target_properties(gmp PROPERTIES INTERFACE_INCLUDE_DIRECTORIES ${CMAKE_SOURCE_DIR}/external/gmp-6.1.2)
endif (WIN32)
